...
import { MyDialog, InputBox, Title, SCREEN_HEIGHT, SCREEN_WIDTH, TabBar, BottomBar } from '../components/Utilities';
...
const refMaps = useRef()
    ...
    return (
     ...
     <BottomBar onPress={() => {navigation.goBack()}} txt={'Donate Easy'} />
